...
O plano completo (Free/Pro/Business, Stripe, auth, YouTube API, resumo AI, geração de roteiros e nuvem de palavras em lives) está em [`docs/PLAN.md`](docs/PLAN.md).
